...
class WaterslideTubeInstanceType private constructor() {
    ...
    companion object {
        ...
        @JvmField
        val INSTANCE: InstanceType<WaterslideTubeInstance> =
            SimpleInstanceType.builder<WaterslideTubeInstance> { type, handle ->
                WaterslideTubeInstance(type, handle)
            }
                .layout(
